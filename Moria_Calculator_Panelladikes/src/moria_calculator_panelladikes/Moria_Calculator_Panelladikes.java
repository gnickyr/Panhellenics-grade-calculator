...
public class Moria_Calculator_Panelladikes {
    ...
    public static void main(String[] args) {
        ...
        int answer;
        // Asking for the student's track
        do {
            System.out.println("\n===========================================");
    ...
    private static void calculateMoria(Scanner in, String sub1, String sub2, String sub3, String sub4) {
        System.out.println("\nParakalw eisagete thn baruthta twn mathimatwn ths sxolhs (se %): ");  // Asks for the weight factors
        ...
        System.out.println("\nParakalw eisagete tous bathmous sas (0-20): "); // Asks for the grades
        ...
        double total_grade = (g1 * w1 / 100 + g2 * w2 / 100 + g3 * w3 / 100 + g4 * w4 / 100) * 1000; // Calculates the total grade
